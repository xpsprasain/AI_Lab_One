...
class Node (var data: String, var leftChild: Node? = null, var rightChild: Node? = null)
...
class BinarySearchTree {
    ...
    fun insertGrandChildren(currentNode: Node, data: String, userAnswer: String) {
...
class AnimalGuessing {
    ...
    private fun learn() {
        ...
        BST.insertGrandChildren(BST.currentNode, newHint, userAnswer) /* Insert newly learned information */
        println("Ok. Got it.")
        replay()
    }
}
...
fun main (args : Array<String>) {
    ...
    game.BST.initialize("Can it fly?", "Pigeon", "Elephant") /* Input initial data */
    game.play() /* Play game */
}